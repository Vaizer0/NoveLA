...
> **Note**: My fork is just for myself. The [original repository](https://github.com/nanihadesuka/NovelDokusha) is no longer actively maintained.

# License
Copyright © 2023, [nani](https://github.com/HnDK0), Released under [GPL-3](LICENSE) FOSS
